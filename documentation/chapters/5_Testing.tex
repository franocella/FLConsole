...
\begin{table}[ht!]
    ...
    \begin{tabularx}{\textwidth}{|c|>{\RaggedRight}p{2.2cm}|>{\RaggedRight}X|>{\RaggedRight}p{2.7cm}|>{\RaggedRight}p{1.98cm}|>{\RaggedRight}p{1.5cm}|}
        ...
        & & Password: invalid (invalid credentials) & & & \\
        \hline
        \multirow{2}{*}{U\_T\_02} & \multirow{2}{2.2cm}{User Signup} & Email: new@example.com & Sign up successfully & Sign up su and Redirected to user dashboard & Passed \\
        & & Password: P@ssw0rd (valid input) & & & \\
        \hline
        \multirow{2}{*}{U\_T\_02} & \multirow{2}{2.2cm}{User Signup 2} & Email: new@example.com & \multirow{2}{\linewidth}{Error message displayed} & Unable to Signup & Passed \\
